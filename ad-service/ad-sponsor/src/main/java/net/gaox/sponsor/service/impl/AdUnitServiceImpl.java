...
import net.gaox.sponsor.service.IAdUnitService;
import net.gaox.sponsor.model.vo.*;
...
public class AdUnitServiceImpl implements IAdUnitService {
    ...
    public AdUnitResponse createUnit(AdUnitRequest request)
        ...
        if (!adPlan.isPresent()) {
            throw new ApiException(Constants.ErrorMsg.CAN_NOT_FIND_RECORD);
        }
        ...
        if (oldAdUnit != null) {
            throw new ApiException(Constants.ErrorMsg.SAME_NAME_UNIT_ERROR);
        }
    ...
    public AdUnitKeywordResponse createUnitKeyword(
            AdUnitKeywordRequest request) throws ApiException {
    ...
    public AdUnitItResponse createUnitIt(
            AdUnitItRequest request) throws ApiException {
    ...
    public AdUnitDistrictResponse createUnitDistrict(
            AdUnitDistrictRequest request) throws ApiException {
    ...
    public CreativeUnitResponse createCreativeUnit(
            CreativeUnitRequest request) throws ApiException {
